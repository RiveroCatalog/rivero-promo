...
if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', wireGabineteCards);
} else {
  wireGabineteCards();
}
window.addEventListener('rivero:live', wireGabineteCards);
})();
